...
| ------------------------------------------------------------ | ---------- | ------- | ------------------------------------------------------------ | ------------------------------------------------------- | ------------------------------------------- |
| SC-GPT-NLU(rich  in ontology, medium ATIS)(Peng et al., 2020) | 92.27      | 89.81   | Data  Augmentation for Spoken Language Understanding via Pretrained Models [[pdf]](https://arxiv.org/pdf/2004.13952.pdf) | -                                                       | arXiv                                       |
...
| MTL-FSN(Louvan  et al., 2019)                                | -          | 89.56   | Leveraging  Non-Conversational Tasks for Low Resource Slot Filling: Does it help? [[pdf]](https://www.aclweb.org/anthology/W19-5911.pdf) | -                                                       | SIGDIAL                                     |
| STL(Louvan  et al., 2019)                                    | -          | 87.91   | Leveraging  Non-Conversational Tasks for Low Resource Slot Filling: Does it help? [[pdf]](https://www.aclweb.org/anthology/W19-5911.pdf) | -                                                       | SIGDIAL                                     |
